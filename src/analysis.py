...
# NUTS2 GeoJSON URL for 2021 (most recent stable version)
...
class RegionalAnalysis:
    def __init__(self, data_path, pillars_dict):
        ...
        Parameters:
        data_path: Path to CSV with regional data
    ...
    def run_analysis(self, geojson_path):
        """
        Run complete analysis pipeline

        Parameters:
        geojson_path: Path to NUTS2 GeoJSON file
